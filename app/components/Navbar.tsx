...
const Navbar = () => {
  return (
    <div className="navbar px-8 py-3 flex border-b border-[#d9d9d9] gap-4 justify-between bg-black_100">
      <div className=" flex items-center gap-4  w-1/3 max-lg:hidden">
      ...
      <div className="w-1/3 flex bg-black_95 px-4 py-[9px] gap-2 rounded-md items-center max-md:w-full">
        <Image
      ...
      <div className=" flex gap-3 w-1/3 justify-end items-center max-md:hidden">
